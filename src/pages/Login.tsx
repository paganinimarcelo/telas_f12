...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange/20 to-success/20 flex items-center justify-center p-4">
      <Card className="w-full max-w-md shadow-2xl border-0 bg-card/95 backdrop-blur">
        <CardHeader className="text-center space-y-4">
          ...
          <CardDescription className="text-muted-foreground">
            Faça login para continuar suas análises
          </CardDescription>
        </CardHeader>
        ...
        <CardContent className="space-y-6">
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <Button 
              type="submit" 
              className="w-full h-12 bg-orange hover:bg-orange/90 text-orange-foreground font-semibold"
            >
              Entrar
            </Button>
          </form>
